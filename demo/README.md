...
A standalone demo for the Tailwind Breakout Grid plugin. No Craft CMS required.
...
Press `Cmd+G` (or `Ctrl+G`) to toggle the grid visualizer overlay.

The visualizer shows:
- Color-coded column areas
- Live CSS variable values
- Padding visualization
- Advanced span examples
